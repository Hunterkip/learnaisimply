          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 bg-background/10 border-background/20 text-background placeholder:text-background/40 focus-visible:ring-accent w-full"
                maxLength={100}
              />
            </div>
          </div>
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Textarea
              ...
              className="pl-10 min-h-[120px] bg-background/10 border-background/20 text-background placeholder:text-background/40 focus-visible:ring-accent resize-none w-full"
              maxLength={1000}
            />
          </div>
        </div>
