  ...
  if (enabledMethods.length === 0) {
    return (
      <div className="text-center py-8">
        <p className="text-muted-foreground">Payment methods are currently unavailable. Please try again later.</p>
      </div>
    );
  }
    ...
    <div className="space-y-6">
        ...
        {mpesaEnabled && (
          ...
          >
            <div className="flex items-center gap-4">
              ...
              {selectedMode === "mpesa" && <Check className="h-5 w-5 text-mpesa" />}
            </div>
          </Card>
        )}
      ...
      {selectedMode === "paypal" && paypalEnabled && (
        <div className="bg-paypal/5 border border-paypal/20 rounded-xl p-6 space-y-4">
          <div className="text-center space-y-2">
            <p className="text-foreground">A new window will open for PayPal payment.</p>
            <p className="text-sm text-muted-foreground">Complete payment in the new window, then return here.</p>
          </div>
          <Button
            size="lg"
        ...
        <div className="bg-mpesa/5 border border-mpesa/20 rounded-xl p-6 space-y-4">
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">You'll receive an M-Pesa STK Push prompt on your phone</p>
            </div>
          </div>
